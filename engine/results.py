...
# Container for one run's raw per-trial data (raw_SI/SU/BI/BU) + metadata, with lossless npz
# save/load (one key per L). The published p_c comes from the raw arrays via extrapolate_pc_raw.
